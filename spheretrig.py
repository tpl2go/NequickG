...
def azimuth(lat1, lon1, lat2, lon2):
        """ azimuth of point 2 as seen from point 1"""
    ...
    # @staticmethod
    # def compute_greatcircle(lat1, lon1, lat2, lon2):
    #     """angle spanned by great arc connecting point 1 and 2
    #     symbol in reference document: delta"""
    #     DR = np.pi / 180.0
    #
    ...
    #     return np.arctan2(sine_delta, cosine_delta) * 180 / np.pi
    #
    # def compute_zenith(self, h1, lat1, lon1, h2, lat2, lon2):
    #     """
    #     zenith angle of point 2 from point 1
    #     :param lat1: [deg]
    #     :param lon1: [deg]
    ...
    #     :return: [deg]
    #     """
    #     delta = self.compute_greatcircle(lat1, lon1, lat2, lon2)
    #
    #     DR = np.pi / 180
    #     cosine = np.cos(delta * DR)
    #     sine = np.sin(delta * DR)
    ...
    #     return zenith
    #
    # def compute_azimuth(self, lat1, lon1, lat2, lon2):
    #     """ azimuth of point 2 as seen from point 1"""
    #
    #     delta = self.compute_greatcircle(lat1, lon1, lat2, lon2)
    #     DR = np.pi / 180
